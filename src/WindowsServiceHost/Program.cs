...
namespace WindowsServiceHost
{
    class Program
    {
        ...
        {
            new HostBuilder()
                //.ConfigureAppConfiguration(cfg => cfg.Add(new Elders.Pandora.PandoraConsulConfigurationSource()))
    ...
    public static class ServiceBaseLifetimeHostExtensions
    {
        ...
        public static IHostBuilder UseStartup(this IHostBuilder builder)
        {
            ...
            builder.ConfigureServices((hostContext, services) => startup.ConfigureServices(services, hostContext));

            return builder;
        }

        public static void Run(this IHostBuilder builder, string[] args)
        {
